...
本文深入探討了從「提示工程」到「上下文工程」的範式轉變。核心發現：**150-300 詞是提示的最佳長度**，超過 3,000 tokens 會導致性能顯著下降。現代推理模型（GPT-5, Claude 4, Gemini 3）內部自動思考，傳統的「逐步思考」提示反而可能損害性能。

**七大核心要素：**
1. Role/Persona：啟動領域知識
