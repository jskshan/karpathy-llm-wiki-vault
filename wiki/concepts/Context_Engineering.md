...
```
你是 Claude，一個由 Anthropic 建立的 AI 助理。
你擅長長文件分析和細致推理。
...
2. **上下文快取**：重用穩定的上下文部分
3. **多模態上下文**：整合文字、圖像、音訊、影片
4. **個性化上下文**：基於使用者歷史和行為定製

## 關聯連結
- [[Prompt_Engineering]] — 提示工程基礎
- [[RAG]] — 檢索增強生成（Context Engineering 的關鍵組件）
- [[摘要-ai-prompt-engineering-2025-2026-espo]] — 來源文件
- [[Agentic_Systems]] — 智能體系統（重度依賴 Context Engineering）
